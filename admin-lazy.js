...
(function () {
    ...
    function _triggerTabInit(n) {
        try {
            ...
            if (n === 3 && typeof loadCategories === 'function') loadCategories(); // BUG-FIX: Tab 3 (Kategorien) hatte keinen Init-Call
            ...
            if (n === 12) {
                if (typeof saOpenTab === 'function') saOpenTab();
            }
            ...
            if (n === 19 && typeof staisyInit === 'function') staisyInit();
        } catch (e) {
